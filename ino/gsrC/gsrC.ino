...
if (String(topic) == "esp32/output/dfPlayerC") {
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    // Attempt to connect
    if (client.connect("gsrC")) {
      Serial.println("connected");
      // Subscribe
      client.subscribe("esp32/output");
      client.subscribe("esp32/output/neopixelC");
      client.subscribe("esp32/output/dfPlayerC");
    } else {
...
*/
    ...
    client.publish("esp32/people/c", peopleString);
