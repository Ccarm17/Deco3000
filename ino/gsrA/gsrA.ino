...
if (String(topic) == "esp32/output/dfPlayerA") {
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    // Attempt to connect
    if (client.connect("gsrA")) {
      Serial.println("connected");
      // Subscribe
      client.subscribe("esp32/output");
      client.subscribe("esp32/output/neopixelA");
      client.subscribe("esp32/output/dfPlayerA");
...
*/
    ...
    client.publish("esp32/people/a", peopleString);
